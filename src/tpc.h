...
{int tmp; \
 tmp = FileAlphaString(10,20,str1.arr); \
 str1.len = tmp; \
 tmp = FileAlphaString(10,20,str2.arr); \
 str2.len = tmp; \
 tmp = FileAlphaString(10,20,city.arr); \
 city.len = tmp; \
...
{int tmp; tmp = FileAlphaString(x,y,str.arr); str.len = tmp;}
