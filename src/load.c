	...
	char           *argv[];
{
	...
	char           db_infilename[DB_STRING_MAX];
        int            port= 3306;
...
retry:
	...
	for (i_id = 1; i_id <= MAXITEMS; i_id++) {
		...
		i_im_id = RandomNumber(1L, 10000L);
                ...
                i_name[ FileAlphaString(14, 24, i_name, filep) ] = 0;
...
retry:
	...
	for (; w_id <= max_ware; w_id++) {
		...
		/* Generate Warehouse Data */
                ...
                w_name[ FileAlphaString(6, 10, w_name, filep) ] = 0;
...
retry:
	for (s_i_id = 1; s_i_id <= MAXITEMS; s_i_id++) {
		...
		s_dist_01[ FileAlphaString(24, 24, s_dist_01, filep) ] = 0;
		s_dist_02[ FileAlphaString(24, 24, s_dist_02, filep) ] = 0;
		s_dist_03[ FileAlphaString(24, 24, s_dist_03, filep) ] = 0;
		s_dist_04[ FileAlphaString(24, 24, s_dist_04, filep) ] = 0;
		s_dist_05[ FileAlphaString(24, 24, s_dist_05, filep) ] = 0;
		s_dist_06[ FileAlphaString(24, 24, s_dist_06, filep) ] = 0;
		s_dist_07[ FileAlphaString(24, 24, s_dist_07, filep) ] = 0;
...
retry:
	for (d_id = 1; d_id <= DIST_PER_WARE; d_id++) {
		...
		d_name[ FileAlphaString(6L, 10L, d_name, filep) ] = 0;
...
retry:
	...
	for (c_id = 1; c_id <= CUST_PER_DIST; c_id++) {
		...
		c_first[ FileAlphaString(8, 16, c_first, filep) ] = 0;
		c_middle[0] = 'O';
		c_middle[1] = 'E';
		c_middle[2] = 0;
		...
		h_data[ FileAlphaString(12, 24, h_data, filep) ] = 0;
...
retry:
	...
	for (o_id = 1; o_id <= ORD_PER_DIST; o_id++) {
		...
		for (ol = 1; ol <= o_ol_cnt; ol++) {
			...
			ol_dist_info[ FileAlphaString(24, 24, ol_dist_info, filep) ] = 0;
...
MakeAddress(str1, str2, city, state, zip)
	...
	char           *zip;
{
	str1[ FileAlphaString(10, 20, str1, filep) ] = 0;	/* Street 1 */
	str2[ FileAlphaString(10, 20, str2, filep) ] = 0;	/* Street 2 */
	city[ FileAlphaString(10, 20, city, filep) ] = 0;	/* City */
	state[ FileAlphaString(2, 2, state, filep) ] = 0;	/* State */
